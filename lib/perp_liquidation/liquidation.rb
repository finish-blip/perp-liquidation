...
module PerpLiquidation
  class Liquidation
    ...
    ALLOWED_TRANSITIONS = {
      ...
      CLAIMED => [PENDING, LOCKING, RETRY_WAIT, REJECTED, CANCELLED, EXPIRED, SUPERSEDED],
      LOCKING => [PENDING, VALIDATING, RETRY_WAIT, REJECTED, CANCELLED, EXPIRED, SUPERSEDED, MANUAL_REVIEW],
      VALIDATING => [PENDING, EXECUTING, RETRY_WAIT, REJECTED, CANCELLED, EXPIRED, SUPERSEDED, MANUAL_REVIEW],
      EXECUTING => [PENDING, ORDER_SUBMITTING, SETTLED, RETRY_WAIT, REJECTED, MANUAL_REVIEW],
